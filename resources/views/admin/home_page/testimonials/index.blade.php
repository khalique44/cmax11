        ...
        <div class="right-section-content">
            <div class="admin-sec-btn-area">
                ...
                <div class="database-btn">
                    <a href="{{ url('admin/home_page/testimonials/create') }}" data-toggle="" data-target="#search-db-model"  class="BE-btn">Add</a>
                </div>
            </div>
                        ...
                        @foreach($records as $key => $record)
                            <tr data-entry-id="{{ $record->id }}">
                                ...
                                <td>
                                    ...
                                    <a href="{{ url('admin/home_page/testimonials/') }}/{{ $record->id }}/edit/" class="text-success" title="Edit Record"><i class="fa fa-pencil"></i></a>
                ...
                datatable.on('row-reorder', function (e, details) {
                    if(details.length) {
                        ...
                        $.ajax({
                            ...
                            method: 'POST',
                            url: "{{ url('admin/home_page/testimonials/update_position') }}",
                            data: { rows }
