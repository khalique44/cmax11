...
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-xs-12">
                    <div class="district-form-content add-new-district-form">
                        <form class="district-fields" method="POST" action='{{url("admin/home_page/testimonials/{$record->id}")}}' enctype="multipart/form-data">
                            {{ method_field('PUT') }}
                            {{ csrf_field() }}
                            <div class="col-xs-12">
                                <div class="form-group">
                                    <label>*Name :</label>
                                    <input type="text" name="client_name" id="client_name" title="enter client name!" class="district-input-field form-control" placeholder="client name"  value="{{old('title', $record->client_name)}}" required >
                                    <div id="msg_1">&nbsp;</div>
                                </div>
                            </div>
                            <div class="col-xs-12">   
    ...
    <script>
        $('.btn_delete').on('click',function () {
            ...
            $(".data-delete-form").attr('action', "{{ url('') }}/admin/home_page/testimonials/"+DataDeleteId);
        });
    </script>
@endsection
