        ...
        <div class="right-section-content">
            <div class="admin-sec-btn-area">
                ...
                <div class="database-btn">
                    <a href="{{ url('admin/home_page/about_section/create') }}" data-toggle="" data-target="#search-db-model"  class="BE-btn">Add</a>
                </div>
            </div>
                            ...
                            <tr data-entry-id="{{ $record->id }}">
                                ...
                                <td>
                                    ...
                                    <a href="{!! url('public') !!}/{{$record->file_url}}" target="_blank">
                                        ...
                                        @else
                                        <img src="{!! url('public') !!}/{{$record->file_url}}" class="logo" alt="Logo" width="20%">
                                        @endif
                                ...
                                <td>
                                    ...
                                    <a href="{{ url('admin/home_page/about_section/') }}/{{ $record->id }}/edit/" class="text-success" title="Edit Record"><i class="fa fa-pencil"></i></a>
               ...
               datatable.on('row-reorder', function (e, details) {
                    if(details.length) {
                        ...
                        $.ajax({
                            ...
                            method: 'POST',
                            url: "{{ url('admin/home_page/about_section/update_position') }}",
                            data: { rows }
