            ...
            <div class="row">
                ...
                <div class="col-xs-12">
                    <div class="district-form-content">
                        <form class="district-fields" method="POST" action="{{url('admin/login_page/general_settings', array('update'))}}" enctype="multipart/form-data">
                            {{method_field('PUT')}}
                            {{csrf_field()}}
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="login_title" id="login_title" title="enter title!" class="district-input-field form-control" placeholder="Title"
                                       value="{{old('login_title',$login_title)}}" required >
                                <div id="msg_1">&nbsp;</div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea  name="login_description" id="login_description" title="enter description!" class="district-input-field form-control" rows="8" placeholder="Description"
                                         >{{old('login_description',$login_description)}}</textarea>
                                <div id="msg_2">&nbsp;</div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <a href="{!! url('public') !!}/{{$login_header_image}}" target="_blank"><img src="{!! url('public') !!}/{{$login_header_image}}" class="logo" alt="Logo" width="50%"></a>
                                @endif
                            </div>                            
