            ...
            <div class="admin-sec-btn-area">
                ...
                <div class="district-back-del-btn-area">
                    <div class="distrcit-back-btn">
                        <div class="district-back-del-btn-area">
                            <a href="{{url('admin/categories')}}" data-toggle="" data-target="#search-db-model"  class="btn btn-sm btn-warning">Back</a>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        <div class="">
                            ...
                            <form class="has-filepond" method="POST" action="{{url('admin/categories/')}}" enctype="multipart/form-data" id="category-form">
                                 {{csrf_field()}}
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3 mt-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" id="name" title="enter category name!" class="district-input-field form-control" placeholder="Category Name" required value="{{old('name')}}">                                    
                                        </div>
                                    </div>
