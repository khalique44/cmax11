        ...
        <div class="right-section-content">
            <div class="admin-sec-btn-area">
                <div class="report-title-section">
                    <h4>{{ isset($property) ? 'Edit Property' : 'Add Property '  }}</h4>
                </div>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="text-center"><h3>{{ 'Project: ' . $project->project_title }}</h3></div>
                    <div class="district-form-content add-new-district-form">
                        <form action="{{ isset($property) ? route('properties.update', $property->id) : route('properties.store') }}" method="POST" enctype="multipart/form-data" class="has-filepond" id="{{ isset($property) ? 'property-form-update' : 'property-form' }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-primary mt-3">{{ isset($property) ? 'Update' : 'Submit & Add More' }}</button>
                                    </div>
                                </div>
                            </div>
                        </form>
