...
@php $bg_image = asset($terms_and_conditions_header_image); @endphp
@endif

<section class="my-banner carers-banner" style="{!! !empty($terms_and_conditions_header_image) ? 
		...
		<div class="row">
			<div data-aos="fade-in" class="col-lg-12">
				<div class="first-heading mb-5 d-block">
					<h2 class="first-h text-center">{{$terms_and_conditions_title}}</h2>
				</div>
