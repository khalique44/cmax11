    ...
    <table width="100%" style="max-width:600px; margin:auto; background:#fff; border-radius:8px; overflow:hidden;">
        <tr style="background:#222; color:#fff;">
            <td style="padding:20px; text-align:center;">
                ...
                <h2 style="margin:10px 0 0; font-size:20px;">New Career Form Message</h2>
            </td>
        </tr>
        <tr>
            <td style="padding:20px; color:#333;">
                ...
                <p><strong>Area of Interests:</strong></p>
                <p style="background:#f9f9f9; padding:10px; border-radius:5px;">{{ $data['area_of_interest'] }}</p>
            </td>
        </tr>
