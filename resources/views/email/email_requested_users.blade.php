                ...
                <div class="header" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);" id="emb-email-header-container">
                    ...
                    <div class="logo emb-logo-margin-box" style="font-size: 26px;line-height: 32px;Margin-top: 6px;Margin-bottom: 20px;color: #41637e;font-family: neighborregular;Margin-left: 20px;Margin-right: 20px;" align="center">
                        <div class="logo-center" align="center" id="emb-email-header">
                            <div class="logo">
                                <a href="{{ url('/') }}">
                                    <img src="{!! url('public/assets/images/logo-white.png') !!}" class="logo" alt="Logo"/>
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="column" style="text-align: left;color: #565656;font-size: 14px;line-height: 21px;font-family: neighborregular;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);">
                            ...
                            <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 24px;">
                                <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
                                    ...
                                    <p style="Margin-top: 20px;Margin-bottom: 20px;text-align: center;">New,&nbsp;<strong>{{ $user->first_name }}&nbsp;{{ $user->last_name }}</strong>&nbsp; With the type of&nbsp;<strong>{{ $user->type }}&nbsp;</strong> and the email address is:&nbsp;<strong>{{ $user->email }}</strong>&nbsp; for registration, please click here to view detail.</p>
                                </div>
                            </div>

                            <div style="Margin-left: 20px;Margin-right: 20px;">
                                <div class="btn btn--shadow btn--large" style="Margin-bottom: 20px;text-align: center;">
                                    <![if !mso]><a style="border-radius: 4px;display: inline-block;font-size: 14px;font-weight: bold;line-height: 24px;padding: 12px 24px 13px 24px;text-align: center;text-decoration: none !important;transition: opacity 0.1s ease-in;color: #ffffff !important;box-shadow: inset 0 -2px 0 0 rgba(0, 0, 0, 0.2);background-color: #c20505;font-family: neighborregular;" href='{{ route("admin.requested_users") }}'>View</a><![endif]>
