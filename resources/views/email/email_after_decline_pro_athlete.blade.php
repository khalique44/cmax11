                        ...
                        <div class="column" style="text-align: left;color: #565656;font-size: 14px;line-height: 21px;font-family: neighborregular;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);">
                            ...
                            <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 24px;">
                                <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
                                    ...
                                    <p style="Margin-top: 20px;Margin-bottom: 20px;text-align: center;">Sorry,&nbsp;<strong>{{ $user->first_name }}&nbsp;{{ $user->last_name }}</strong>&nbsp;Your Account&nbsp;<strong>{{ $user->email }}</strong> has not been approved by,&nbsp;<strong>Admin.&nbsp;</strong></p>
                                </div>
                            </div>
                        </div>
                        <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
