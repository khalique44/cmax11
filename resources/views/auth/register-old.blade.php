...
<div class="inner-page-banner blue-bg">
    <div id="main_header" class="main-header inner-page-header membership-page">
        <div class="container">
            <div class="logo">
                <a href="{{ url('/') }}"><img src="{!! url('public/assets/images/NPC-WorldWide-logo-RD-WT-BL-R-v6.png') !!}" class="logo" alt="Logo"></a>
            </div>
                            ...
                            <div class="select-section-content">
                                ...
                                <div class="reg-select-card-section">
                                    {{--<div id="sect-1" class="checkbox-btn-option">
                                        ...
                                        <div for="reg-1" class="reg-card-content">
                                            <div class="card-image">
                                                <img src="{!! url('public/assets/images/athlete-icon.png') !!}">
                                            </div>
                                    ...
                                    <div id="sect-3" class="checkbox-btn-option">
                                        <input id="reg-3" type="radio" name="reg-select" value="reg-select">
                                        <div for="reg-3" class="reg-card-content">
                                            <div class="card-image">
...
<script >
    ...
    var three = document.getElementById("reg-3");
    ...
    two.onclick = function(){
        var link = document.getElementById("btn_click");
        link.setAttribute("href", "athlete");
        return true;
    };
    three.onclick = function(){
        var link = document.getElementById("btn_click");
        link.setAttribute("href", "non-athlete");
        return true;
    };
</script>
</body>
