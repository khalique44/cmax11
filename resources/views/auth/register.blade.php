      ...
      <div class="slid-header pt-md-5 pb-md-4 mx-auto">
        ...
        <div class="row">
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 text-center">
             ...
             <h1 class="display-4 mt-2 mt-md-5 mt-lg-5">LOGGA <span>IN</span></h1>

             <p class="lead-c text-center w-100">Läs varför ett boende på Rosen i Vara är ett så gott boende!</p>
          ...
          <div class="login-box">
            ...
            <form class="loginform p-5" method="POST" action="{{ route('login') }}" aria-label="{{ __('Login') }}">
              ...
              <div class="form-group">
                ...
                <input id="username" placeholder="{{ __('Username') }}" type="username" class="{{ $errors->has('username') ? ' is-invalid' : '' }} form-control" name="username" value="{{ old('username') }}" required autofocus>
